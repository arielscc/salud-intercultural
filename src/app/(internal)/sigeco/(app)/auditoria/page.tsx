...
const actionLabels: Record<string, string> = {
  ...
  "cash.session.open": "Abrió una sesión de Caja",
  "cash.expense.staff.create": "Registró dinero entregado al personal",
  "cash.expense.purchase.create": "Registró una compra urgente",
  "cash.expense.other.create": "Registró otro egreso de Caja",
  "cash.session.close.request": "Solicitó o completó un cierre de Caja",
  "cash.session.close.approve": "Aprobó una diferencia de Caja",
  "cash.movement.reverse": "Registró una corrección de Caja",
  "cash.receipt.read": "Consultó un comprobante de gasto",
