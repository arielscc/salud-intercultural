...
export function WhatsAppFloatingButton({ phone }: WhatsAppFloatingButtonProps) {
  ...
  return (
    <a
      ...
      className="focus-ring fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-success text-white shadow-lift ring-8 ring-success/10 transition hover:-translate-y-1 hover:bg-primary sm:bottom-5 sm:right-5"
    >
