...
| 2026-08-03 | [Tarea 8: catálogo administrable de estudios](./2026-08-03-catalogo-administrable-estudios.md) | Estudios configurables desde SIGECO, con selección dinámica y recorrido pago en Administración → ejecución en Enfermería. |
